  ...
  return (
    <>
      <SEO
        ...
        keywords="Zeo Tourism, Nepal tours 2024, Nepal travel packages, trekking in Nepal, luxury Nepal holidays, cultural tours Kathmandu, Mount Everest trekking, Annapurna circuit, spiritual tours Nepal, local travel agency Nepal"
      ...
      <div className="home-page">
        <Hero />
        <h1 className="sr-only">Zeo Tourism - Premier Nepal Tour & Adventure Specialist</h1>
