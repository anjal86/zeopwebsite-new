...
const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 shadow-xl flex items-center justify-center cursor-pointer overflow-hidden"
